...
```{r fig.width = 8.5, fig.height = 8.5/1.7}
plot_grid(
...
```{r message=FALSE, fig.width=8, fig.height=8/(2*1.35)}
...
```{r message=FALSE, fig.width=8, fig.height=8/1.35}
plot_grid(plot.mpg, NULL, NULL, plot.diamonds, labels = c("A", "B", "C", "D"), ncol = 2)
```

```{r message=FALSE, fig.width=8/2, fig.height=8/1.35}
...
The resulting figure:
```{r echo=FALSE, fig.width=6, fig.height=6/1.35}
