...
The default design of **cowplot**, by contrast, is clean and simple. It looks similar to **ggplot2**'s `theme_classic()`, but there are important but subtle differences we'll discuss later.
```{r echo=FALSE, message=FALSE}
require(cowplot)
