...
```{r, eval=FALSE, message=FALSE, fig.width=4.25, fig.height=3.4}
require(cowplot)
...
```{r, eval=FALSE, message=FALSE, fig.width=4.25, fig.height=3}
mtcars2 <- mtcars[1:15, ]
...
```{r, eval=FALSE, message=FALSE, fig.width=4.25, fig.height=5.1}
require(gtable)
# top plot
p1 <- ggplot(mtcars, aes(mpg, disp)) + geom_line(colour = 'blue') +
