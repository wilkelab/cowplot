...
---
As of ggplot2 2.2.0, ggplot2 now natively supports secondary axes and axes on either side of the plot. Therefore, the cowplot function `switch_axis_position()` has been deprecated, since it always was an ugly hack and difficult to maintain. Here are some examples of how alternative axes can be created with ggplot2.
